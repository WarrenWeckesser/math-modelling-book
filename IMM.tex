\documentclass[reqno,letterpaper,11pt]{immbook}
%
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amssymb}
...
\newcommand{\MS}{{\textbf{S}}}
\newcommand{\MI}{{\textbf{I}}}
\newcommand{\MZero}{{\textbf{0}}}% Matrix Zero (not "Z")
%
...
\vspace{0.25in}
{\small Copyright \copyright ~2005, 2006, 2019 Warren Weckesser}
}
%
...
\include{chapter_Probability_Appendix}
