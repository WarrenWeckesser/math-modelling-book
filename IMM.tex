...
\emph{Newton's Law of Cooling} says that the rate of change
...
\centerline{\includegraphics[width=4in]{AutonomousDegreeThreePlota.eps}}
...
\centerline{\includegraphics[width=4in]{AutonomousDegreeThreePlotb.eps}}
