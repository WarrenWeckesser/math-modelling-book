...
We let $\gamma$ be the interaction rate, with units of
...
\end{equation}
We can think of this expression as having
the units \emph{average number of SI interactions per
interaction}.
By assumption (\ref{SI_assume_const_rate}),
the quantity $\frac{2\gamma}{N^2}SI$
...
We consider another example, in which we model
the interaction of a predator and its prey.
